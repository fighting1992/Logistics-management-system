                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i> 车辆维修登记</h4>
                            <span class="tools">
                         ...
                         <div class="widget-body">
                             <div>
                                 <div class="clearfix">
                                     <div class="btn-group">
                                         <button >
                                            <a class="b_add" href="<?php echo site_url('repaired/add');?>">添加 <i class="icon-plus"></i></a>
                                         </button>
                                     </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     <tr class="">
                                         ...
                                         <td><?php echo $row->record_start_date;?></td>
                                         <td><?php echo $row->record_end_date;?></td>
                                         <td><?php echo $row->broken_part;?></td>
                                         <td><a href="<?php echo site_url("repaired/edit/$row->record_id")?>">编辑</a></td>
                                         <td><a href="<?php echo site_url("repaired/delete/$row->record_id")?>">删除</a></td>
                                     </tr>
                                     <?php }?>
                                     </tbody>
                                 </table>
