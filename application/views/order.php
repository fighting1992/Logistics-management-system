...
<body class="fixed-top">
                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i> 订单信息管理</h4>
                            <span class="tools">
                         ...
                         <div class="widget-body">
                             <div>
                                 <div class="clearfix">
                                     <div class="btn-group">
                                         <button >
                                            <a class="b_add" href="<?php echo site_url('order/add');?>">添加 <i class="icon-plus"></i></a>
                                         </button>
                                     </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     <tr class="">
                                         ...
                                         <td><?php echo $row->goods_weight;?></td>
                                         <td><?php echo $row->order_state;?></td>
                                         <td><?php echo $row->order_cost;?></td>
                                         <td><?php echo $row->order_address;?></td>
                                         <td><a href="<?php echo site_url("order/edit/$row->order_id")?>">编辑</a></td>
                                         <td><a href="<?php echo site_url("order/delete/$row->order_id")?>">删除</a></td>
                                     </tr>
                                     <?php }?>
                                     </tbody>
                                 </table>
   ...
   <script src="<?php echo site_url('assets/js/order_table.js'); ?>" ></script>
