                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 修改司机信息</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('driver/do_edit')?>" method="post" class="form-horizontal">
                            <input type="hidden" class="input-large" name="id" value="<?php echo $drivers->driver_id;?>"/>
                            <div class="control-group">
                                <label class="control-label">司机id</label>
                                <div class="controls">
                                        <input type="text" class="input-large" name="id" disabled="disabled" value="<?php echo $drivers->driver_id;?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text"  class="input-large" name="name" value="<?php echo $drivers->driver_name;?>"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">司机联系方式</label>
                                <div class="controls">
                                        <input type="text"  class="input-large" name="tel" value="<?php echo $drivers->driver_tel;?>"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
