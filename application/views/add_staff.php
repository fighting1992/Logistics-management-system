                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 添加员工信息</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('staff/do_add')?>" method="post" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text"  class="input-large" name="salary"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="input-large m-wrap" tabindex="1" name="limit">
                                            <option value="0">普通员工</option>
                                            <option value="1">系统管理员</option>
                                            <option value="2">入库管理员</option>
                                            <option value="3">出库管理员</option>
                                            <option value="3">订单配送管理员</option>
                                    </select>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">管理员登陆名</label>
                                <div class="controls">
                                        <input type="text"  class="input-large" name="admin_name"/>
                                        <span class="help-inline">如果为普通员工以下两项无需填写，可直接提交</span>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">管理员密码</label>
                                <div class="controls">
                                        <input type="text"  class="input-large" name="pwd"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
