                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 修改订单 </h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('order/do_edit')?>" method="post" class="form-horizontal">
                            <input type="hidden" class="input-large" name="id" value="<?php echo $orders->order_id;?>"/>
                            <div class="control-group">
                                <label class="control-label">订单号</label>
                                <div class="controls">
                                        <input type="text" disabled="disabled" class="input-large" name="id" value="<?php echo $orders->order_id;?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input id="dp1" type="text" value="<?php echo $orders->order_date;?>" size="16" class="input-large" name="date">
                                </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <?php foreach($users as $row){
                                         if($row->user_id==$orders->user_id){  
                                     ?>
                                            <option value="<?php echo $row->username?>" selected="selected"><?php echo $row->username?></option>
                                    <?php  }else{
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text" value="<?php echo $orders->goods_name;?>" class="input-large" name="goods_name"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text" value="<?php echo $orders->goods_weight;?>" class="input-large" name="goods_weight"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <select class="input-large m-wrap" tabindex="1" name="state">
                                            <option value="已收件"<?php if($orders->order_state=="已收件"){?> selected="selected"<?php }?> >已收件</option>
                                            <option value="已发货"<?php if($orders->order_state=="已发货"){?> selected="selected"<?php }?> >已发货</option>
                                            <option value="已收货"<?php if($orders->order_state=="已收货"){?> selected="selected"<?php }?> >已收货</option>
                                            <option value="暂无状态"<?php if($orders->order_state=="暂无状态"){?> selected="selected"<?php }?> >暂无状态</option>
                                    </select>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">订单费用</label>
                                <div class="controls">
                                    <div class="input-prepend input-append">
                                        <span class="add-on">￥</span><input class=" " type="text" name="cost" value="<?php echo $orders->order_cost;?>"/><span class="add-on">.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " name="add" value="<?php echo $orders->order_address;?>"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
