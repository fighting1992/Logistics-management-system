                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 修改库存信息</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('total/do_edit')?>" method="post" class="form-horizontal">
                           <input type="hidden" class="input-large" name="id" value="<?php echo $records->goods_id?>"/>
                            <div class="control-group">
                                <label class="control-label">货物id</label>
                                <div class="controls">
                                        <input type="text" value="<?php echo $records->goods_id?>" class="input-large" name="id" disabled="disabled"/>
                            ...
                            <div class="control-group">
                                <label class="control-label">货物总量</label>
                                <div class="controls">
                                        <input type="text" class="input-large" name="total" value="<?php echo $records->goods_total?>"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>                         
