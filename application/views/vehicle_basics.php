                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i> 车辆基本信息</h4>
                            <span class="tools">
                         ...
                         <div class="widget-body">
                             <div>
                                 <div class="clearfix">
                                     <div class="btn-group">
                                         <button >
                                            <a class="b_add" href="<?php echo site_url('basics/add');?>">添加 <i class="icon-plus"></i></a>
                                         </button>
                                     </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     <tbody>
                                     <?php foreach($basics as $row){
                                     
                                     ?>
                                     <tr class="">
                                         <td><?php echo $row->vehicle_id;?></td>
                                         <td><?php echo $row->vehicle_num;?></td>
                                         <td><?php echo $row->drivername->driver_name;?></td>
                                         <td><?php echo $row->vehicle_size;?></td>
                                         <td><?php echo $row->vehicle_max;?></td>
                                         <td><a href="<?php echo site_url("basics/edit/$row->vehicle_id")?>">编辑</a></td>
                                         <td><a href="<?php echo site_url("basics/delete/$row->vehicle_id")?>">删除</a></td>
                                     </tr>
                                     <?php }?>
                                     </tbody>
                                 </table>
