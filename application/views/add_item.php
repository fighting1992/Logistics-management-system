                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 添加配送明细</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('send/do_add_item/'.$table_id)?>" method="post" class="form-horizontal">
                            <input type="hidden" class="input-large" name="id"/>
                            <div class="control-group">
                                <label class="control-label">订单id</label>
                                <div class="controls">
                                    <select class="input-large m-wrap" tabindex="1" name="order_id">
                            ...
                            <input type="hidden" class="input-large" name="send_id" value="<?php echo $table_id?>"/>
