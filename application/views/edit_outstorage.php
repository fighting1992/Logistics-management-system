                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 修改出库信息</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('outstorage/do_edit')?>" method="post" class="form-horizontal">
                           <input type="hidden" class="input-large" name="id" value="<?php echo $records->outstorage_id?>"/>
                            <div class="control-group">
                                <label class="control-label">出库id</label>
                                <div class="controls">
                                        <input type="text" value="<?php echo $records->outstorage_id?>" class="input-large" name="id" disabled="disabled"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <?php foreach($staffs as $row){
                                     ...
                                     ?>
                                            <option value="<?php echo $row->staff_id?>" selected="selected"><?php echo $row->staff_id?></option>
                                    <?php  }else{
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input id="dp1" type="text" value="<?php echo $records->outstorage_date?>" size="16" class="input-large" name="date">
                                </div>
                            </div>
                            <div class="control-group">
