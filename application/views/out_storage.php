                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i> 出库信息</h4>
                            <span class="tools">
                         ...
                         <div class="widget-body">
                             <div>
                                 <div class="clearfix">
                                     <div class="btn-group">
                                         <button >
                                            <a class="b_add" href="<?php echo site_url('outstorage/add');?>">添加 <i class="icon-plus"></i></a>
                                         </button>
                                     </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     ?>
                                     <tr class="">
                                         <td><?php echo $row->outstorage_id;?></td>
                                         <td><?php echo $row->staff_id;?></td>
                                         <td><?php echo $row->outstorage_date;?></td>
                                         <td ><?php echo $row->goods_name;?></td>
                                         <td ><?php echo $row->goods_num;?></td>
                                         <td><a href="<?php echo site_url("outstorage/edit/$row->outstorage_id")?>">编辑</a></td>
                                         <td><a href="<?php echo site_url("outstorage/delete/$row->outstorage_id")?>">删除</a></td>
                                     </tr>
                                     <?php }?>
