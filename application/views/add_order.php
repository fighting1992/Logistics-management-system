                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('order/do_add')?>" method="post" class="form-horizontal">
                            <div class="control-group">
                                <label class="control-label">订单号</label>
                                <div class="controls">
                                        <input type="text" value="<?php date_default_timezone_set('PRC'); echo date('YmdHis').rand(10,99)?>" class="input-large" name="id" />
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    <span class="help-inline"><a href="<?php echo site_url('user/add');?>">添加新的用户</a></span>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text" placeholder="" class="input-large" name="goods_name"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text" placeholder="" class="input-large" name="goods_weight"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <div class="input-prepend input-append">
                                        <span class="add-on">￥</span><input class=" " type="text" name="cost"/><span class="add-on">.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="span6 " name="add"/>
                                    <span class="help-inline"></span>
                                </div>
                            </div>
