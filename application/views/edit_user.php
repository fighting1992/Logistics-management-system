                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 修改用户信息</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('user/do_edit')?>" method="post" class="form-horizontal">
                            <input type="hidden" class="input-large" name="id" value="<?php echo $users->user_id;?>"/>
                            <div class="control-group">
                                <label class="control-label">用户id</label>
                                <div class="controls">
                                        <input type="text" class="input-large" name="id" disabled="disabled" value="<?php echo $users->user_id;?>"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text"  class="input-large" name="name" value="<?php echo $users->username;?>"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text"  class="input-large" name="pwd" value="<?php echo $users->password;?>"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text"  class="input-large" name="email" value="<?php echo $users->email;?>"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text"  class="input-large" name="tel" value="<?php echo $users->tel;?>"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text"  class="input-large" name="home_add" value="<?php echo $users->home_add;?>"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
