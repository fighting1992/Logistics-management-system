                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 修改车辆信息</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('basics/do_edit')?>" method="post" class="form-horizontal">
                            <input type="hidden" class="input-large" name="id" value="<?php echo $basics->vehicle_id;?>"/>
                            <div class="control-group">
                                <label class="control-label">车辆 I D</label>
                                <div class="controls">
                                        <input type="text" disabled="disabled" value="<?php echo $basics->vehicle_id;?>" class="input-large" name="id"/>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text" value="<?php echo $basics->vehicle_num;?>" class="input-large" name="num"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                     <select class="input-large m-wrap" tabindex="1" name="driver_id">
                                    <?php foreach($drivers as $row){
                                         if($row->driver_id==$basics->driver_id){  
                                     ?>
                                            <option value="<?php echo $row->driver_id?>" selected="selected"><?php echo $row->driver_name?></option>
                                    <?php  }else{
                            ...
                            <div class="control-group">
                                <label class="control-label">货车型号</label>
                                <div class="controls">
                                        <input type="text" value="<?php echo $basics->vehicle_size;?>" class="input-large" name="size"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">最大载重量</label>
                                <div class="controls">
                                        <input type="text" value="<?php echo $basics->vehicle_max;?>" class="input-large" name="max"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
