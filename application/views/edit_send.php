                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('send/do_edit')?>" method="post" class="form-horizontal">
                            <input type="hidden" class="input-large" name="id" value="<?php echo $records->send_id;?>"/>
                            <div class="control-group">
                                <label class="control-label">配送id</label>
                                <div class="controls">
                                    <input type="text" class="input-large" name="id" value="<?php echo $records->send_id;?>" disabled="disabled"/>
