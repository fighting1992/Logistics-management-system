                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 添加车辆信息</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('basics/do_add')?>" method="post" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text" class="input-large" name="size"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text" class="input-large" name="max"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
