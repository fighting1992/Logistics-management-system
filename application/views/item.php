                 ...
                 <div class="span12">
                     ...
                     <div class="widget purple">
                         <div class="widget-title">
                             <h4><i class="icon-reorder"></i> 详细信息</h4>
                            <span class="tools">
                         ...
                         <div class="widget-body">
                             <div>
                                 <div class="clearfix">
                                     <div class="btn-group">
                                         <button >
                                            <a class="b_add" href="<?php echo site_url('send/add_item/'.$table_id);?>">添加 <i class="icon-plus"></i></a>
                                         </button>
                                     </div>
                                 ...
                                 <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                     ...
                                     <tr class="">
                                         ...
                                         <td><a href="<?php echo site_url("send/record/$row->item_id")?>">详细信息</a></td>                                     
                                     <!--<td><a href="<?php echo site_url("send/edit_item/$row->item_id")?>">编辑</a></td>-->
                                         <td><a href="<?php echo site_url("send/delete_item/$row->item_id")?>">删除</a></td>
                                     </tr>
                                     <?php }?>
