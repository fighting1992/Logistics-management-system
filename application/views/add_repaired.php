                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 添加维修记录</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('repaired/do_add')?>" method="post" class="form-horizontal">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input id="dp1" type="text" value="2014-01-01" size="16" class="input-large" name="start">
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input id="dp2" type="text" value="2014-01-01" size="16" class="input-large" name="end">
                                        <span class="help-inline"></span>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                        <input type="text" class="input-large" name="broken_part"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
