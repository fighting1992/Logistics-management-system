                ...
                <div class="span12">
                    ...
                    <div class="widget green">
                        <div class="widget-title">
                            <h4><i class="icon-reorder"></i> 修改违章记录</h4>
                            <span class="tools">
                        ...
                        <div class="widget-body">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo site_url('illegal/do_edit')?>" method="post" class="form-horizontal">
                            <input type="hidden" class="input-large" name="id" value="<?php echo $records->illegal_id;?>"/>
                            <div class="control-group">
                                <label class="control-label">维修记录id</label>
                                <div class="controls">
                                        <input type="text" class="input-large" name="id" disabled="disabled" value="<?php echo $records->illegal_id;?>"/>
                            ...
                            <div class="control-group">
                                <label class="control-label">违章日期</label>
                                <div class="controls">
                                        <input id="dp1" type="text" value="<?php echo $records->illegal_date;?>" size="16" class="input-large" name="date">
                                        <span class="help-inline"></span>
                                </div>
                            </div> 
                            <div class="control-group">
                                <label class="control-label">违章原因</label>
                                <div class="controls">
                                        <input type="text" class="input-large" name="reason" value="<?php echo $records->illegal_reason;?>"/>
                                        <span class="help-inline"></span>
                                </div>
                            </div>
